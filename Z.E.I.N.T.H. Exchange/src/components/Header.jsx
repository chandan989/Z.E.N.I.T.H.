...
return (
    <header className="w-full flex items-center justify-between p-6 md:p-8 flex-shrink-0">
        ...
        <nav className="hidden md:flex items-center space-x-8 text-sm">
            <a href="/exchange" className="text-stardust-grey hover:text-white transition-colors duration-300">Exchange</a>
            <a href="/constellations" className="text-stardust-grey hover:text-white transition-colors duration-300">Constellations</a>
            <a href="/portfolio" className="text-stardust-grey hover:text-white transition-colors duration-300">Portfolio</a>
            <a href="/docs" className="text-stardust-grey hover:text-white transition-colors duration-300">Docs</a>
        </nav>
        <button
